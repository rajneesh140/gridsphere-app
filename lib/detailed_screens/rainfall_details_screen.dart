...
class RainfallDetailsScreen extends StatefulWidget {
  ...
  @override
  State<RainfallDetailsScreen> createState() => _RainfallDetailsScreenState();
}
...
class _RainfallDetailsScreenState extends State<RainfallDetailsScreen> {
  ...
  Future<void> _fetchHistoryData(String range) async {
    ...
    try {
      ...
      debugPrint("Error fetching rainfall history: $e");
    }
  }
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFE0F2FE), // Light Indigo/Blue
              ...
              children: [
                Expanded(
                  child: _buildStatBox(
                    ...
                    Colors.blue,
                    _selectedRange == 'daily' ? "Last 24h" : "Period Total",
                  ),
                ),
                ...
                Expanded(
                  child: _buildStatBox(
                    "Peak Intensity",
                    "${maxIntensity.toStringAsFixed(1)} mm",
                    LucideIcons.zap,
                    Colors.orange,
                    maxTime,
                  ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Rainfall Pattern (${_getRangeLabel()})",
                    style: GoogleFonts.inter(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.black87,
