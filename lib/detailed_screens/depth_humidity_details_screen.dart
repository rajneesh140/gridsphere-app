...
class DepthHumidityDetailsScreen extends StatefulWidget {
  final Map<String, dynamic>? sensorData;
  final String deviceId;
  final String sessionCookie;

  const DepthHumidityDetailsScreen({
    super.key, 
    this.sensorData, 
  ...
  @override
  State<DepthHumidityDetailsScreen> createState() => _DepthHumidityDetailsScreenState();
}

class _DepthHumidityDetailsScreenState extends State<DepthHumidityDetailsScreen> {
  ...
  Future<void> _fetchHistoryData(String range) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (readings.isNotEmpty) {
          ...
          for (var r in readings) {
            // Parse Depth Humidity
            double val = double.tryParse(r['depth_humidity'].toString()) ?? 0.0;
      ...
      debugPrint("Error fetching depth humidity history: $e");
    }
  }

  @override
  Widget build(BuildContext context) {
    double currentHum = widget.sensorData?['depth_humidity'] ?? 0.0;
    double maxHum = 0.0;
    double minHum = 0.0;
    String maxTime = "--";
    String minTime = "--";
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(LucideIcons.bot, size: 20, color: Color(0xFF00695C)),
                  ...
                  Text(
                    "Soil moisture at depth is within the ideal range. Root zone hydration is adequate. Continue monitoring to optimize irrigation cycles.",
                    style: GoogleFonts.inter(
                      fontSize: 13,
                  ...
                  SizedBox(
                    ...
                    child: _isLoading 
                      ...
                      : _errorMessage.isNotEmpty
                          ...
                          : CustomPaint(
                              painter: _DepthHumidityChartPainter(
...
class _DepthHumidityChartPainter extends CustomPainter {
  final List<GraphPoint> dataPoints;
  final Color color;
  final String range;

  _DepthHumidityChartPainter({
