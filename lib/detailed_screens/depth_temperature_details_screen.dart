...
class DepthTemperatureDetailsScreen extends StatefulWidget {
  final Map<String, dynamic>? sensorData;
  final String deviceId;
  final String sessionCookie;

  const DepthTemperatureDetailsScreen({
    super.key, 
    this.sensorData, 
  ...
  @override
  State<DepthTemperatureDetailsScreen> createState() => _DepthTemperatureDetailsScreenState();
}

class _DepthTemperatureDetailsScreenState extends State<DepthTemperatureDetailsScreen> {
  ...
  Future<void> _fetchHistoryData(String range) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (readings.isNotEmpty) {
          ...
          for (var r in readings) {
            double val = double.tryParse(r['depth_temp'].toString()) ?? 0.0;
      ...
      debugPrint("Error fetching depth temp history: $e");
    }
  }

  @override
  Widget build(BuildContext context) {
    double currentTemp = widget.sensorData?['depth_temp'] ?? 0.0;
    double maxTemp = 0.0;
    double minTemp = 0.0;
    String maxTime = "--";
    String minTime = "--";
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(LucideIcons.bot, size: 20, color: Color(0xFFD84315)),
                  ...
                  Text(
                    "Soil temperature at depth is stable. Optimal for root activity and nutrient uptake. Ensure irrigation does not cause rapid cooling shocks.",
                    style: GoogleFonts.inter(
                      fontSize: 13,
                  ...
                  SizedBox(
                    ...
                    child: _isLoading 
                      ...
                      : _errorMessage.isNotEmpty
                          ...
                          : CustomPaint(
                              painter: _DepthTempChartPainter(
...
class _DepthTempChartPainter extends CustomPainter {
  final List<GraphPoint> dataPoints;
  final Color color;
  final String range;

  _DepthTempChartPainter({
