...
class SurfaceHumidityDetailsScreen extends StatefulWidget {
  final Map<String, dynamic>? sensorData;
  final String deviceId;
  final String sessionCookie;

  const SurfaceHumidityDetailsScreen({
    super.key, 
    this.sensorData, 
  ...
  @override
  State<SurfaceHumidityDetailsScreen> createState() => _SurfaceHumidityDetailsScreenState();
}

class _SurfaceHumidityDetailsScreenState extends State<SurfaceHumidityDetailsScreen> {
  ...
  Future<void> _fetchHistoryData(String range) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (readings.isNotEmpty) {
          ...
          for (var r in readings) {
            double val = double.tryParse(r['surface_humidity'].toString()) ?? 0.0;
      ...
      debugPrint("Error fetching surface humidity history: $e");
    }
  }

  @override
  Widget build(BuildContext context) {
    double currentHum = widget.sensorData?['surface_humidity'] ?? 0.0;
    double maxHum = 0.0;
    double minHum = 0.0;
    String maxTime = "--";
    String minTime = "--";
    ...
    // final double surfaceTemp = widget.sensorData?['surface_temp'] ?? 0.0; // Not used in this layout now
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(LucideIcons.bot, size: 20, color: Color(0xFF5D4037)),
                  ...
                  Text(
                    "Surface moisture levels directly impact fungal growth risk. Keep monitor values to prevent diseases like apple scab.",
                    style: GoogleFonts.inter(
                      fontSize: 13,
                  ...
                  SizedBox(
                    ...
                    child: _isLoading 
                      ...
                      : _errorMessage.isNotEmpty
                          ...
                          : CustomPaint(
                              painter: _SurfaceHumidityChartPainter(
...
class _SurfaceHumidityChartPainter extends CustomPainter {
  final List<GraphPoint> dataPoints;
  final Color color;
  final String range;

  _SurfaceHumidityChartPainter({
