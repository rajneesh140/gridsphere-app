...
class _ChemicalProcessStabilityScreenState
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (readings.isNotEmpty) {
          ...
          temperature = double.tryParse(reading['temp'].toString()) ?? 0.0;
  ...
  void _calculateStabilityScores() {
    ...
    double reactorScore = min((tempScore * 0.7 + pressScore * 0.3), 100);
    double materialsScore = min((humScore * 0.7 + tempScore * 0.3), 100);
    double vesselScore = min((pressScore * 0.6 + tempScore * 0.4), 100);
    double atmosphericScore =
        min((tempScore * 0.4 + humScore * 0.3 + pressScore * 0.3), 100);
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildSimpleCard("Humidity", "${humidity.toStringAsFixed(0)} %",
              ...
              _buildSimpleCard(
                  ...
                  LucideIcons.flame),
              _buildSimpleCard("Comfort Level", _getComfortLevel(),
                  LucideIcons.thermometerSun),
              _buildSimpleCard(
                  "Process Risk", _getProcessRisk(), LucideIcons.alertTriangle),
            ],
          ),
          const SizedBox(height: 40),
        ],
